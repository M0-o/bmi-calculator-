    ...
    return (
        <View
            style={{
                ...
                alignItems: "center",
                backgroundColor: "#8a4bff15",
            }}
        >
            <Text style={styles.h1}>IMC FOR II MASTER BDCC 1</Text>
            ...
            <View>
                <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 10 }}>
                    ...
                    <TextInput placeholder="Entrez votre poids" value={weight == 0 ? null : weight.toString()} keyboardType="numeric" onChange={e => setWeight(Number(e.nativeEvent.text))} style={styles.input} />
                    <Text style={styles.inputLabel}>Kg</Text>
                </View>
                <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 10 }}>
                    <Text style={styles.inputLabel}>Taille</Text>
                    <TextInput placeholder="Entrez votre taille" value={height == 0 ? null : height.toString()} keyboardType="numeric" onChange={e => setHeight(Number(e.nativeEvent.text))} style={styles.input} />
                ...
                >
                    <Text style={{ color: "white", fontSize: 16, textAlign: "center" }}>Calculer IMC</Text>
                </TouchableOpacity>
            </View>
            <Text style={styles.h3}> Votre IMC est : {imc == 0 ? "" : imc.toPrecision(4)}</Text>
